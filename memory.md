...
- Last validated: 2026-07-18 (PyPy 7.3.23, Python 3.11)
...
- Benchmarks (PyPy 7.3.23, 2026-07-18 run 46):
  - request_handler import: ~1.47 ms, traffic_router: ~0.88 ms
  - data_processor/ml_pipeline: FAILED (pandas/matplotlib not installed in sandbox — expected)
  - Dispatch (JIT-warm): ~0.02–1.19 µs/call
