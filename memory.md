...
- Last validated: 2026-07-21 (PyPy 7.3.23, Python 3.11)
...
- Benchmarks (PyPy 7.3.23, 2026-07-21 run 49):
  - traffic_router: ~0.80 ms
  - data_processor/ml_pipeline: FAILED (pandas/matplotlib not installed in sandbox — expected)
  - Dispatch (JIT-warm): ~0.02–0.20 µs/call
...
- Run 47 (2026-07-19): Task 1, Task 4, Task 7
