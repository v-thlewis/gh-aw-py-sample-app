...
def measure_gpu_performance():
    """Function that uses torch - lazily imported."""
    import torch
...
def create_visualization(data):
    """Function that uses matplotlib - lazily imported."""
...
def load_sample_data():
    """Function that uses sklearn - lazily imported."""
    from sklearn import datasets
    iris = datasets.load_iris()
    return iris.data, iris.target

def process_data():
    """Function that uses numpy - lazily imported."""
    import numpy as np
